...
<Container>
<Row className="justify-content-md-center align-items-center">
<Col sm><img src={weare} style={{width: "90%", height: "55%"}}></img></Col>
    <Col sm style={{ textAlign: "left" }}>
        <h4 style={{color: "black", fontFamily: "Poppins", textAlign: "left"}}>Who are we?</h4>
        <br></br>
...
We are a tech company to tackle all your problems and queries. <br></br><br></br>
...
Care-Box Tech began its business operation as a software, hardware, and network solutions company in February 2021. We provide a one-stop solution for your trade and industry. Depending on the size and field of your organization, we have different IT products and services to meet your requirements. Moreover, impeccable customized technology solutions are also provided. <br></br><br></br>
{/* 
